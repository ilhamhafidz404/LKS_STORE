            ...
            @foreach ($transactions as $transaction)
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="flex justify-between p-6 bg-white border-b border-gray-200">
                        <div>
                            <h2 class="text-xl">{{$transaction->product->name}}</h2>
                            <small class="text-gray-400">sebanyak</small>
                            <span class="text-md font-bold">{{$transaction->total}}</span> 
                            <small class="text-gray-400">pcs</small>
                        </div>
                        <div>
                            <small class="text-gray-400">Invoice</small>
                            <h6 class="text-md font-bold">{{$transaction->code_transaction}}</h6>
                        </div>
                    </div>
                </div>
            @endforeach
